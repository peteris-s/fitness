        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-200">
                    ...
                    {{-- Exercises + Start flow: show a prominent Start button when not in progress, reveal exercises and Complete form when started --}}
                    <div x-data="{ inProgress: @json(session('start', false)) }">
                        <div class="mb-4">
                            <button x-show="!inProgress" @click="inProgress = true" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded">
                                Start workout
                            </button>
                            <button x-show="inProgress" @click="inProgress = false" class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-4 rounded">
                                Cancel session
                            </button>
                        </div>
