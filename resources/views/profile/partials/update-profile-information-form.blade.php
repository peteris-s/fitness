    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div>
            ...
            <div class="flex items-center gap-4 mt-2">
                ...
                @endif
                <input id="avatar" name="avatar" type="file" accept="image/*" class="text-sm text-gray-500 dark:text-gray-300" />
            </div>
        ...
        <div>
            ...
            <textarea id="bio" name="bio" rows="3" class="mt-1 block w-full rounded-md border-gray-300 dark:bg-gray-800 dark:border-gray-700 dark:text-white">{{ old('bio', $user->bio) }}</textarea>
